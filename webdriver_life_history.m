...
% plot(day_t/100,log10(plot_fish),'r','LineWidth',1);
% plot(day_t/100,log10(plot_invert),'b','LineWidth',1);
% %plot(day,log10(B));
...
plot(day_t/100,log10(B_species),'LineWidth',1.5);%Including Inverts & Plants
