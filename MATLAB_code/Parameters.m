...
%% MassCalc
    masscalc.num_orig_fish=10; %Max number of fish species allowed in original model.  If NaN is used, you choose 60% of species with species with TL>=3 (trophic level)
