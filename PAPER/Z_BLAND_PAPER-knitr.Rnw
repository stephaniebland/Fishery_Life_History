...
Figure \ref{fig:Lifestage_prey} shows how a species' prey will be assigned to lifestages. In this example, \ref{fig:Lifestage_prey}An example of prey division among lifestages. This species eats prey in the niche value range of [5,17] over 9 lifestages.
