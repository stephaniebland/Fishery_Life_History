...
require(ggplot2)
@
\caption{An example of prey division among lifestages. This species eats prey in the niche value range of [5, 17], over 9 lifestages. Each lifestage i eats prey in the niche value range of $[a_i, b_i]$.} 
\end{figure} 
