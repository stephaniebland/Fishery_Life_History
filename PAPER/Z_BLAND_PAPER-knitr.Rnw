...
Figure \ref{fig:Lifestage_prey} shows how a species' prey will be assigned to lifestages. In this example, \ref{fig:Lifestage_prey}An example of prey division among lifestages. This species eats prey in the niche value range of \ref$[\Sexpr{niche_range}]$ over
