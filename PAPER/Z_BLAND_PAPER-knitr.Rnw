...
\begin{itemize}
  ...
  \item Set a lower limit for the weight of the smallest lifestage, and choose the number of lifestages accordingly.
\end{itemize}
...
\par Alright, you need three parameters according to the traditional von-bert model:
\begin{equation}
